...
def me_cmd(
    ...
    table.add_row("external_id", str(getattr(auth_me, "external_id", None) or ""))
    table.add_row("privy_user_id", str(getattr(auth_me, "privy_user_id", None) or ""))
    table.add_row("wallet_address", str(getattr(auth_me, "wallet_address", None) or ""))
    table.add_row("team_id", auth_me.team_id)
    table.add_row("plan_id", auth_me.plan_id)
    table.add_row("email", str(auth_me.email or ""))
    table.add_row("user_type", str(getattr(auth_me, "user_type", None) or ""))
