...
describe('HyperClaw agents SDK', () => {
  ...
  it('buildOpenClawTrustedProxiesEnv returns the trusted-proxy replacement env', () => {
    expect(buildOpenClawTrustedProxiesEnv(['10.0.0.0/8', ' 127.0.0.1 '])).toEqual({
      OPENCLAW_TRUSTED_PROXIES: '10.0.0.0/8,127.0.0.1',
    });
  });
