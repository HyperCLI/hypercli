...
def test_agents_urls_default_to_agents_hosts(monkeypatch):
    ...
    assert config.get_agents_api_base_url() == "https://api.agents.hypercli.com/api"
    assert config.get_agents_ws_url() == "wss://api.agents.hypercli.com/ws"
    assert config.get_agents_api_base_url(dev=True) == "https://api.agents.dev.hypercli.com/api"
...
def test_agents_urls_use_env_overrides(monkeypatch):
    monkeypatch.setenv("AGENTS_API_BASE_URL", "https://api.agents.dev.hypercli.com/api")
    ...
    assert config.get_agents_api_base_url() == "https://api.agents.dev.hypercli.com/api"
