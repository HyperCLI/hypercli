    ...
    <>
      ...
      <section className="relative py-24 px-4 sm:px-6 lg:px-8 overflow-hidden bg-background">
        ...
        >
          {/* Dramatic headline */}
          <motion.h3 
            className="text-5xl sm:text-6xl text-foreground mb-8 leading-[1.05] tracking-tight max-w-4xl mx-auto"
          ...
          {/* Supporting copy */}
          <motion.p 
            className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed mb-16"
