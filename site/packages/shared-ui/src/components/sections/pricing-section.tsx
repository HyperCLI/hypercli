            ...
            <div>
              <ul className="space-y-6">
                {features.map((feature, idx) => (
                  ...
                  >
                    <motion.div 
                      className="w-10 h-10 rounded-lg bg-primary/8 flex items-center justify-center flex-shrink-0 group-hover:bg-primary/15 transition-colors"
                      whileHover={{ scale: 1.15 }}
                    >
                      <Check className="w-5 h-5 text-primary" />
                    </motion.div>
                    <span className="text-xl text-secondary-foreground group-hover:text-foreground transition-colors pt-1.5">{feature}</span>
                  </motion.li>
                ))}
              </ul>
            </div>
