...
describe("OpenClawBootstrapStep", () => {
  it("renders one form panel while rebuilding workspace files behind it", async () => {
    ...
    await waitFor(() => expect(latestDraft!.files.find((file) => file.name === "AGENTS.md")?.content)
