        ...
        <header className="border-b border-border pb-5">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div className="flex shrink-0 flex-nowrap items-center gap-1.5">
              ...
              {skill.editable && (localPreview || skill.documentState === "loaded") && <Button type="button" variant={editing ? "secondary" : "outline"} size="sm" onClick={() => { setActiveTab("overview"); setEditing(true); }} className="h-8 min-h-0 gap-1.5 px-2.5 text-[11px] hover:bg-surface-high hover:text-foreground dark:hover:bg-surface-high"><Settings2 className="h-3.5 w-3.5" />Edit instructions</Button>}
