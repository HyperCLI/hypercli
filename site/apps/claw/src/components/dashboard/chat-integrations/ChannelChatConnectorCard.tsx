...
export function ChannelChatConnectorCard({
  ...
  useEffect(() => {
    ...
    beginDirectSetup();
  }, [channelId, connected, configured, directSetup, whatsAppPairingState?.status]);
              ...
              <div className="rounded-2xl border border-[var(--channel-accent-border)] bg-background/75 p-4 sm:p-5">
                {whatsAppQrDataUrl ? (
                  <div className="flex flex-col items-center gap-5 sm:gap-6">
                    ...
                    <div className="relative mx-auto w-full max-w-[22rem] overflow-hidden rounded-[1.35rem] border border-[var(--channel-accent-border)] bg-white p-4 shadow-[0_18px_60px_rgba(0,0,0,0.3)]">
                      <Image
