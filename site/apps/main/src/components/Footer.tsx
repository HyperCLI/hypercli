...
const footerLinks = {
  ...
  solutions: [
    ...
    { label: "Data Centers", href: "/datacenter" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="col-span-2">
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="w-9 h-9 rounded-lg bg-[#161819] hover:bg-[#1D1F21] flex items-center justify-center transition-colors"
              >
                <svg className="w-4 h-4 text-[#9BA0A2]" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {footerLinks.product.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm text-[#9BA0A2] hover:text-white transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
        ...
        <div className="pt-8 border-t border-[#2A2D2F] flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link href="/privacy" className="text-sm text-[#6E7375] hover:text-[#9BA0A2] transition-colors">
              Privacy Policy
            </Link>
            <Link href="/terms" className="text-sm text-[#6E7375] hover:text-[#9BA0A2] transition-colors">
              Terms of Service
            </Link>
          </div>
        </div>
