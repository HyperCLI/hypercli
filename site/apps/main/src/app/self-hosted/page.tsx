  ...
  return (
    <MarketingShell header={<Header />} footer={<Footer />} headerClearance="section-nav">
      ...
      <AuroraHero backdropVariant="standard">
        <MarketingEyebrow>HyperCLI Self-Hosted</MarketingEyebrow>
        <AuroraHeroHeading>
          The whole platform.
          <br />
        ...
        <ContactCta
          source="self-hosted-hero-talk-to-engineering"
          secondarySource="self-hosted-hero-architecture-brief"
      ...
      <MarketingBand bordered>
        <MarketingContainer className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <MarketingBand bordered className="text-center">
        <MarketingContainer>
          ...
          <p className="mx-auto mb-12 max-w-2xl text-lg text-text-secondary">
            The question stops being &quot;which AI vendor?&quot; and becomes &quot;what should we build this week?&quot; —
            with models that get better at your business the longer you run them.
          </p>
      ...
      {/* Closer */}
      <AuroraFinalCta
        heading="Own the factory, not just the output."
        description="A working pilot on your hardware in 30 days. Talk to an engineer, not a sales deck."
        descriptionClassName="mx-auto max-w-xl"
        actions={
          <ContactCta
            source="self-hosted-final-talk-to-engineering"
            secondarySource="self-hosted-final-architecture-brief"
            primaryLabel="Talk to engineering"
            secondaryLabel="Get the architecture brief"
            theme="dark"
          />
