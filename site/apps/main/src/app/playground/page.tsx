...
const playgrounds = [
  ...
  {
    id: "gradio",
    title: "Gradio Templates",
    description: "Ready-to-run Gradio applications for TTS, voice cloning, and audio processing. Deploy with Docker on GPU.",
    icon: (
      <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
