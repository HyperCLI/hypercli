...
export default function Home() {
  return (
    <MarketingShell header={<Header />} footer={<Footer />} headerClearance="primary">
      ...
      <AuroraHero backdropVariant="wide">
        <AuroraHeroHeading>
        ...
        <MarketingActionGroup className="mt-11 gap-8">
        ...
        <MarketingBand bordered className="text-center">
          <MarketingContainer width="4xl">
            <MarketingEyebrow>The agent</MarketingEyebrow>
        ...
        {/* Night timeline */}
        <MarketingBand spacing="none" className="px-6 pb-12" id="night">
          <MarketingContainer width="4xl" className="relative overflow-hidden rounded-3xl bg-terminal-background px-8 py-16 text-center">
            <div
              aria-hidden="true"
        ...
        <AuroraFinalCta
          ...
          footnote="7-day free Team trial · No per-token pricing, ever · It never buys or ships anything without you"
        />
    </MarketingShell>
  );
}
