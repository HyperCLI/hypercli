          ...
          <div className="prose prose-invert max-w-none space-y-8">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                HyperCLI, Inc. (&quot;HyperCLI&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;) provides a platform
                for GPU orchestration, LLM inference, image and video generation,
                and related developer tools. This Privacy Policy describes how we
                collect, use, and protect your information when you use our
                platform and related services (the &quot;Services&quot;), including our
                API, SDK, CLI, web console, and documentation.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground mt-4 space-y-2">
                <li>
                  <strong className="text-foreground">Email/passkey authentication:</strong>{" "}
                  Your email address
                </li>
                <li>
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                Authentication is handled by Turnkey, a third-party identity provider.
              ...
              <h3 className="text-xl font-medium text-foreground mt-6 mb-3">
                2.3 API and Service Usage Data
              </h3>
              <p className="text-muted-foreground leading-relaxed">
                When you use our Services, we collect operational metadata:
              </p>
              <ul className="list-disc list-inside text-muted-foreground mt-4 space-y-2">
                <li>Request timestamps</li>
                <li>Token counts (input and output) for LLM requests</li>
                <li>Model identifiers</li>
                <li>GPU type and job duration for compute jobs</li>
                <li>Response latency</li>
                <li>Error codes (when applicable)</li>
              </ul>
              <p className="text-muted-foreground leading-relaxed mt-4">
                This metadata is used for billing, rate limiting, and service
                monitoring. It does not include the content of your prompts,
                model responses, uploaded files, or job outputs.
              </p>
            ...
            <section>
              ...
              <h3 className="text-xl font-medium text-foreground mt-6 mb-3">
                4.1 Prompt, Completion, and Job Data
              </h3>
              <p className="text-muted-foreground leading-relaxed">
                <strong className="text-foreground">We do not store the content of your API requests or responses.</strong>{" "}
                Prompts, completions, uploaded files, and job outputs are processed
                in real-time and are not persisted after the request or job completes.
                We do not retain logs of what you send to or receive from the models.
              </p>
              <p className="text-muted-foreground leading-relaxed mt-4">
                <strong className="text-foreground">We do not use your data for model training.</strong>{" "}
                Your prompts, completions, files, and any data you transmit through
                our Services are never used to train, fine-tune, or improve AI models.
              </p>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground mt-4 space-y-2">
                <li>
                  <strong className="text-foreground">Turnkey</strong> — Identity
                  and authentication for email/passkey login.
                </li>
                <li>
                ...
                <li>
                  ...
                  hosting, GPU compute, and data storage.
                </li>
              </ul>
              <p className="text-muted-foreground leading-relaxed mt-4">
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground mt-4 space-y-2">
                <li>
                  ...
                  Stored in cookies or localStorage to maintain your logged-in session.
                </li>
                <li>
                  <strong className="text-foreground">Essential cookies:</strong>{" "}
                  Used by Turnkey and Stripe for authentication and payment flows.
                </li>
              </ul>
              <p className="text-muted-foreground leading-relaxed mt-4">
                We do not use advertising cookies, tracking pixels, or third-party
                analytics services that track you across other websites.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground mt-4 space-y-2">
                <li>All data transmitted to and from our API is encrypted using TLS</li>
