...
This is different from models like Kimi K2.5 which use a separate `reasoning` field. To extract just the answer, strip content before the closing `</think>` tag.
