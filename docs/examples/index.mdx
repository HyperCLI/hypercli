...
<Card title="GLM-5 on H200" icon="bolt" href="/examples/glm-5">
  Deploy Zhipu AI's 744B parameter reasoning model with FP8 weights, speculative decoding, and toggleable thinking.
</Card>

<Card title="MiniMax M2.5 on RTX Pro 6000" icon="microchip" href="/examples/minimax-m2-5">
  Deploy MiniMax's 229B MoE model (10B active) on 4x RTX Pro 6000 — $5/hr with built-in reasoning and tool calling.
</Card>
