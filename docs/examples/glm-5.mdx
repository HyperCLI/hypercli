...
<Note>
For the hosted HyperClaw chat API, prefer the Anthropic Messages endpoint at `https://api.hyperclaw.app` when you want the best tool calling behavior. The OpenAI-compatible `/v1` route remains available for compatibility.
</Note>
