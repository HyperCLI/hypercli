...
<Note>
For the hosted HyperCLI chat API, prefer the Anthropic Messages endpoint at `https://api.hypercli.com` when you care about tool calling quality. The OpenAI-compatible `/v1` route still works, but Anthropic-format routing is the recommended default.
</Note>
